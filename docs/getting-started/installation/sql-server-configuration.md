...
description: Configure SQL Server for AuditMate MFG
category: Getting Started > Installation Guide
---

# SQL Server Configuration

Proper configuration of **SQL Server** is required to ensure successful installation and database connectivity for **AuditMateMFG™ Revision Manager**.
...
After completing the SQL Server configuration, proceed to [IIS Setup](/docs/getting-started/installation/iis-setup) to continue the installation.
